  ...
  return (
    ...
    >
      ...
      <div
        ...
        data-side={side}
        className={cn(
          "fixed z-10 hidden w-(--sidebar-width) top-1/2 -translate-y-1/2 max-h-[85vh] transition-[left,right,width] duration-200 ease-linear data-[side=left]:left-0 data-[side=left]:group-data-[collapsible=offcanvas]:left-[calc(var(--sidebar-width)*-1)] data-[side=right]:right-0 data-[side=right]:group-data-[collapsible=offcanvas]:right-[calc(var(--sidebar-width)*-1)] md:flex",
      ...
      >
        <div
          ...
          className="flex w-full max-h-[85vh] flex-col bg-black/60 backdrop-blur-xl group-data-[variant=floating]:rounded-2xl group-data-[variant=floating]:shadow-2xl group-data-[variant=floating]:shadow-black/40 group-data-[variant=floating]:ring-1 group-data-[variant=floating]:ring-white/[0.06]"
        >
          {children}
        </div>
      </div>
...
function SidebarGroupLabel({
  ...
  return useRender({
    ...
    props: mergeProps<"div">(
      {
        className: cn(
          "flex h-6 shrink-0 items-center rounded-lg px-1 text-[10px] font-medium uppercase tracking-wider text-white/40 ring-sidebar-ring outline-hidden transition-[margin,opacity] duration-200 ease-linear group-data-[collapsible=icon]:-mt-8 group-data-[collapsible=icon]:opacity-0 focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0",
          className
        ),
      },
      props
